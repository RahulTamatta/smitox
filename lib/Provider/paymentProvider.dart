      ...
      try {
        ...
        if (!error) {
          ...
          if (instamojo) {
            ...
            context.read<CartProvider>().instamojoClientId =
                payment['instamojo_client_id'];
            context.read<CartProvider>().instamojoClientSecretKey =
                payment['instamojo_client_secret'];
            context.read<CartProvider>().instamojoOrderCreationUrl =
                payment['instamojo_webhook_url'];
          }
...
/*       if (paytmResponse['error']) {
  ...
  Future<Map<String, dynamic>> paywithInstamojo({
    required String userID,
    required String orderID,
    required String paymentAmount,
    required String instamojoCallBackURL,
    required String paytmMerchantID,
    required bool isTestingModeEnable,
  }) async {
    try {
      ...
      Map<dynamic, dynamic> paytmResponse =
          await PaymentRepository.payWithPaytm(
                  apiParameter: parameter,
                  paytmCallbackURL: instamojoCallBackURL,
                  paytmMerchantID: paytmMerchantID,
                  paytmOrderID: orderID,
                  paytmTransactionAmount: paymentAmount,
                  isTestingModeEnable: isTestingModeEnable)
