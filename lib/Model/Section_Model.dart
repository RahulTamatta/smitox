...
class Product {
  ...
  List<ProductSet>? productSets; // Added productSets
  ...
  Product(
      ...
      this.otherImage,
      this.prVarientList,
      this.productSets, // Added productSets
      this.attributeList,
      this.isFav,
      this.isCancelable,
      this.isReturnable,
  ...
  factory Product.fromJson(Map<String, dynamic> json) {
    ...
    List<ProductSet> productSets = (json['sets'] as List? ?? [])
        .map((data) => ProductSet.fromJson(data))
        .toList();
    ...
    return Product(
        ...
        productSets: productSets, // Added productSets
...
class ProductSet {
  ...
  ProductSet({
    ...
    this.discountMrp,
    this.discountPriceSet,
    this.sellingPriceSet,
    this.createdAt,
    this.status,
  });
  ...
  factory ProductSet.fromJson(Map<String, dynamic> json) {
    return ProductSet(
      ...
      discountMrp: json['discount_mrp'],
      discountPriceSet: json['discount_price_set'],
      sellingPriceSet: json['selling_price_set'],
