...
class AddAddress extends StatefulWidget {
  ...
  const AddAddress(
      {Key? key, required this.update, this.index, required this.fromProfile})
      : super(key: key);
...
class StateAddress extends State<AddAddress> with TickerProviderStateMixin {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      if (mounted) {
        ...
        if (widget.update) {
          ...
          stateC!.text = item.state!;
          cityC!.text = item.landmark!;
          areaC!.text = item.pincode!;
  ...
  Future<void> checkNetwork() async {
    ...
    print('isNetworkAvail: $isNetworkAvail');

    if (isNetworkAvail) {
      print('Calling addNewAddress method');
      ...
      print('Network not available. Waiting for 2 seconds.');
      ...
      await Future.delayed(const Duration(seconds: 2)).then(
        (_) async {
          ...
          if (context.read<AddressProvider>().buttonController != null) {
            await context.read<AddressProvider>().buttonController!.reverse();
          }

          print('Network not available after 2 seconds.');
        },
      );
    }
  }
      ...
      child: Container(
        ...
        child: Padding(
          ...
          child: TextFormField(
            ...
            readOnly: false,
            controller: nameC, // Use the correct controller for the user name
            ...
            onChanged: (v) => setState(
              () {
                context.read<AddressProvider>().name = v;
              },
            ),
  ...
  //           textInputAction: TextInputAction.next,
  //           readOnly: false,
  //           controller: cityC, // Use the correct controller for the user name
  //           textCapitalization: TextCapitalization.words,

  //           onSaved: (String? valueC) {
  //             context.read<AddressProvider>().city = valueC;
  //           },
  //           onChanged: (vC) => setState(
  //             () {
  //               context.read<AddressProvider>().city = vC;
  //             },
  //           ),
  //           style: Theme.of(context)
  //               .textTheme
      ...
      child: Container(
        ...
        child: Padding(
          ...
          child: TextFormField(
            ...
            controller:
                mobileC, // Use the correct controller for the mobile number
            ...
            onChanged: (v) => setState(
              () {
                context.read<AddressProvider>().mobile = v;
              },
            ),
            decoration: InputDecoration(
  ...
  //       text: context.read<AddressProvider>().selectedZipcode);
  ...
  //             labelText: getTranslated(context, 'PINCODESELECT_LBL'),
  //             labelStyle: Theme.of(context).textTheme.bodySmall,
  //           ),
  //           style: TextStyle(
  //             color: context.read<AddressProvider>().selectedZipcode != null
  //                 ? Theme.of(context).colorScheme.fontColor
  //                 : Colors.grey,
  //             fontFamily: 'ubuntu',
  //           ),
  ...
  //                 context.read<AddressProvider>().selCityPos != -1) {
  //               // You can access entered value using zipcodeController.text
  //               // Example: String enteredPincode = zipcodeController.text;
  //               // Perform actions or validations based on entered value
  //             } else {
  //               setSnackbar(
  //                 getTranslated(context, 'PLZ_START_SEL_CITY_LBL')!,
  //                 context,
  //               );
  //             }
  //           },
            ...
            child: Container(
              ...
              child: Padding(
                ...
                child: TextFormField(
                  ...
                  onChanged: (v) => setState(
                    () {
                      context.read<AddressProvider>().areaName = v;
                    },
                  ),
                  decoration: InputDecoration(
                    label: Text(
      ...
      child: Container(
        ...
        child: Padding(
          ...
          child: TextFormField(
            keyboardType: TextInputType.text,
            textCapitalization: TextCapitalization.sentences,
            controller: addressC, // Use the correct controller for the address
            style: Theme.of(context)
                .textTheme
                .titleSmall!
                .copyWith(color: Theme.of(context).colorScheme.fontColor),
            ...
            onChanged: (a) {
              setState(() {
                context.read<AddressProvider>().address = a;
              });
            },
            onSaved: (String? a) {
              context.read<AddressProvider>().address = a;
      ...
      child: Container(
        ...
        child: Padding(
          ...
          child: TextFormField(
            keyboardType: TextInputType.text,
            textCapitalization: TextCapitalization.sentences,
            controller: cityC, // Use the correct controller for the address
            style: Theme.of(context)
                .textTheme
                .titleSmall!
                .copyWith(color: Theme.of(context).colorScheme.fontColor),
            ...
            onChanged: (z) {
              setState(() {
                context.read<AddressProvider>().city = z;
              });
            },
            onSaved: (String? cn) {
              context.read<AddressProvider>().city = cn;
            },
            decoration: InputDecoration(
              label: const Text(
                'City',
        ...
        child: Padding(
          ...
          child: TextFormField(
            ...
            style: Theme.of(context)
                ...
                .titleSmall!
                .copyWith(color: Theme.of(context).colorScheme.fontColor),
            onSaved: (String? cntryC) {
              context.read<AddressProvider>().country = cntryC;
            },
            onChanged: (country) => setState(
              () {
                context.read<AddressProvider>().country = country;
              },
            ),
            validator: (val) => StringValidation.validateField(
              val!,
