...
import 'package:eshop_multivendor/Screen/Product%20Detail/productDetailsHome.dart';
...
class ProductdetailsMore extends StatefulWidget {
  final Product? model;
...
class StateItem extends State<ProductdetailsMore>
    ...
    if (isNetworkAvail) {
      if (context.read<UserProvider>().userId != '') {
        ...
        qty = (int.parse(controllerText[index].text) -
            int.parse(widget.model!.prVarientList![0].unit_set.toString()));
  ...
  Widget build(BuildContext context) {
    if (widget.index < productList.length) {
      ...
      return Consumer<CartProvider>(builder: (context, data, _) {
        ...
        controllerText[index].text = widget.model!.prVarientList![0].unit_set!;
        if (tempId != null) {
