...
import 'Widget/helper/shimmerLoading.dart';
...
class StateItem extends State<ProductDetailHome> with TickerProviderStateMixin {
  ...
  Future<void> addToCartDeatail(int index, String qty, int from) async {
    ...
    if (isNetworkAvail) {
      if (context.read<UserProvider>().userId != '') {
        ...
        if (int.parse(qty) <
            int.parse(widget.model!.minOrderQuntity.toString())) {
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<CartProvider>(builder: (context, data, _) {
      ...
      if (tempId != null) {
        ...
        final unitSet = widget.model!.prVarientList![index].unit_set!;
        controllerText[index].text =
            widget.model!.prVarientList![index].unit_set!;
      }
      String initialQuantity = widget.model!.minOrderQuntity.toString();
                                                                    ...
                                                                    Checkbox(
                                                                      ...
                                                                      onChanged:
                                                                        ...
                                                                        setState(
                                                                            () {
                                                                          print(
                                                                              'check${controllerText[index].text}');
                                                                        });
                                                                      },
                                                                    ),
                                                                  ],
