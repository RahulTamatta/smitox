...
class StateCart extends State<Cart> with TickerProviderStateMixin {
  ...
  final ScrollController _scrollControllerOnSaveForLaterItems =
      ScrollController();
  List<String> methods = ['Select payment method', 'Advance', 'Prepaid'];
...
//  bool isAvailable = true;
  ...
  _showContent1(BuildContext context) {
    ...
    return Consumer<CartProvider>(builder: (context, cartProvider, child) {
      List<SectionModel> cartList = cartProvider.cartList;
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                              ...
                              child: SingleChildScrollView(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    if (cartProvider.saveLaterList.isNotEmpty)
                                      Padding(
                                        padding: const EdgeInsets.all(8.0),
                                        child: Text(
                                          getTranslated(
                                    ...
                                    if (cartProvider.saveLaterList.isNotEmpty)
                                      ListView.builder(
                                        shrinkWrap: true,
                                        itemCount:
                                            cartProvider.saveLaterList.length,
                                        physics:
                                            const NeverScrollableScrollPhysics(),
                                        itemBuilder: (context, index) {
                                          return SaveLatterIteam(
                        ...
                        Column(
                          ...
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: <Widget>[
                            if (cartProvider.promoList.isNotEmpty &&
                                cartProvider.oriPrice > 0)
                              Padding(
                                padding: const EdgeInsetsDirectional.only(
                                  ...
                                  children: [
                                    Container(
                                      ...
                                      child: TextField(
                                        ...
                                        controller: cartProvider.promoC,
                                        style: Theme.of(context)
                                            .textTheme
                                            .titleSmall,
                                        ...
                                        onChanged: (val) {
                                          setState(() {
                                            if (val.isEmpty) {
                                              cartProvider.isPromoLen = false;
                                              cartProvider.isPromoValid = false;
                                              promoEmpty().then((value) {
                                                cartProvider.promoAmt = 0;
                                              });
                                            } else {
                                              cartProvider.isPromoLen = true;
                                              cartProvider.isPromoValid = false;
                                            }
                                          });
                                        },
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        Text(getTranslated(
                                            context, 'TOTAL_PRICE')!),
                                        Text(
                                          '${DesignConfiguration.getPriceFormat(context, cartProvider.selectedPe == 'Advance' ? (cartProvider.oriPrice * double.parse(cartProvider.percentage ?? '0') / 100) : cartProvider.oriPrice)!} ',
                                          style: Theme.of(context)
                                              .textTheme
                                              .titleMedium!
                                              .copyWith(
                        ...
                        SimBtn(
                          ...
                          height: 40,
                          borderRadius: circularBorderRadius5,
                          title: cartProvider.isPromoLen
                              ? getTranslated(context, 'VALI_PRO_CODE')
                              : getTranslated(context, 'PROCEED_CHECKOUT'),
                          onBtnSelected: () async {
                            if (cartProvider.isPromoLen == false) {
                              if (cartProvider.oriPrice > 0) {
                                FocusScope.of(context).unfocus();
                                if (cartProvider.isAvailable) {
                                  if (cartProvider.totalPrice != 0) {
                                    checkout();
                                    cartProvider.getTax(context);
                                    var stats = cartProvider.getStatus!;
                                    print(' status $stats');
                                  }
                                } else {
                                  setSnackbar(
                              ...
                              await context
                                  ...
                                  .validatePromocode(
                                      check: false,
                                      context: context,
                                      promocode: cartProvider.promoC.text,
                                      update: setStateNow)
                                  .then(
                                (value) {
                                  setState(() {
                                          ...
                                          child: Padding(
                                            ...
                                            child: Column(
                                              ...
                                              children: [
                                                ...
                                                //         });
                                                //         print(
                                                //             'objects  ${context.read<CartProvider>().setSelectedMethod(selectedMethod)}');

                                                //         print(
                                                //             'Status ${context.read<CartProvider>().getStatus}');

                                                //         print(
                                                //             'Status ${context.read<CartProvider>().getPercentage}');
                                                //         print(
                                                //             'Method ${context.read<CartProvider>().selectedPe}');
                                                //       },
                                                //       items: methods.map<
                                                //               DropdownMenuItem<
                                                //                   String>>(
                                      ...
                                      children: <Widget>[
                                        Padding(
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              Text(
                                                '${DesignConfiguration.getPriceFormat(context, context.read<CartProvider>().selectedPe == 'Advance' ? ((context.read<CartProvider>().totalPrice * double.parse(context.read<CartProvider>().percentage ?? '0') / 100)) : context.read<CartProvider>().totalPrice)!} ',
                                                style: TextStyle(
                                                  color: Theme.of(context)
                                                      .colorScheme
                                                      .fontColor,
  ...
  razorpayPayment(
    ...
    var totalPriceRazor = context.read<CartProvider>().selectedPe == 'Advance'
        ? (((context.read<CartProvider>().totalPrice) * 100) *
            (double.parse(context.read<CartProvider>().percentage ?? '0') /
                100))
    ...
    try {
      ...
      String amt = (context.read<CartProvider>().selectedPe == 'Advance'
          ? ((context.read<CartProvider>().totalPrice *
                  double.parse(context.read<CartProvider>().percentage ?? '0')))
              .toStringAsFixed(2)
          : (context.read<CartProvider>().totalPrice * 100).toStringAsFixed(2));
      ...
      print('Order id $razorpayOrderId and $orderID');
      var options = {
...
/*    String orderId = DateTime
  ...
  Future<void> placeOrder(String? tranId) async {
    ...
    if (isNetworkAvail) {
      ...
      try {
        var priceRazor = context.read<CartProvider>().selectedPe == 'Advance'
            ? (context.read<CartProvider>().totalPrice *
                (double.parse(context.read<CartProvider>().percentage ?? '0') /
                    100))
            : context.read<CartProvider>().totalPrice.toString();
  ...
  cartItems(List<SectionModel> cartList, var check) {
